...
此版未恢復的自動關機已由 v1.57.0 接手；舊排程不會因更新而自動重新生效。
...
| 功能 | 目前提供 |
| --- | --- |
| 家庭待辦／週期待辦 | 成員及私人／公開事項、完成與封存、到期提醒；同名待辦以 ID 定位，無法唯一辨識時詢問日期時間；可選 Notion 同步 |
...
| Hue | 區域開關、亮度、場景、支援的燈效與通知；待辦可複選照明區域，固定呼吸提醒；HA Hue 啟用時經 HA |
